...
int main()
{
   ...
   line(0, 300, 150, 550);//A(-4,2), B(-1,7)
    line(150, 450, 350, 600);//C(-1,5), D(3,8)
    line(100, 350, 250, 300);//E(-2,3), F(1,2)
    line(250, 100, 350, 350);//G(1,-2), H(3,3)
    line(0, 550, 100, 700);//I(-4,7), J(-2,10)
